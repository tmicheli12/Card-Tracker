  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <div className="card space-y-4">
        <h2 className="font-semibold text-zinc-200">PSA Grading</h2>
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          {saved && (
            <div className="rounded-lg bg-emerald-900/40 border border-emerald-700 p-3 text-emerald-300 text-sm font-medium text-center">
              ✓ Saved
            </div>
          )}
      ...
      <div className="mt-6 card space-y-2">
        <h2 className="font-semibold text-zinc-200">About</h2>
